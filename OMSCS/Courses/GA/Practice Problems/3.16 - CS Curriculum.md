...
| Vertex | i=nil | i=1 | i=2 | i=3 | i=4 | i=5 | i=6 | i=7 | i=8 | i=9 | i=10 |
| ------ | ----- | --- | --- | --- | --- | --- | --- | --- | --- | --- | ---- |
...
## Algorithm
We use the TopoSort algorithm to generate an array of the vertices of $G$ in topological order $TO$. We also generate the reverse of $G$, $G^R=(V, E^R)$.
