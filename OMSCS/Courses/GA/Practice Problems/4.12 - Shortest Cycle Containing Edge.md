...
This doesn't necessarily beat the required runtime of $O(n^2)$. In fact, it's worse. However, the course instructors specifically called out the fact that our runtime will be worse than the provided guidance, while staying within the expectations for how we're running the graphs unit.