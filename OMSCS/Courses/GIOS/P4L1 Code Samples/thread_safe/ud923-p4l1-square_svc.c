...
{
	union {
		square_in square_proc_1_arg;
	} argument;
	union {
		square_out square_proc_1_res;
	} result;
	bool_t retval;
	...
	case SQUARE_PROC:
		...
		local = (bool_t (*) (char *, void *,  struct svc_req *))square_proc_1_svc;
		break;
	...
	if (!square_prog_1_freeresult (transp, _xdr_result, (caddr_t) &result))
